...
class Preprocessor:
    ...
    def _fetch_data(self) -> pd.DataFrame:
        ...
        with engine.connect() as conn:
            data = pd.read_sql(q, conn.connection)
    ...
    def _transform_with_robust_scaler(
        ...
        for feature in features:
            ...
            print(f'RobustScaler has been applied to {feature} feature.')
            robust_scalers[feature] = scaler

        joblib.dump(robust_scalers, os.path.join(self._encoder_path, "robust_scaler.joblib"))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--model_name', type=str, default='credit_score_classification', dest='model_name'
    )
    parser.add_argument(
        '--base_dt', type=str, default=DateValues.get_current_date(), dest='base_dt'
    )
